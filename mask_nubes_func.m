function [mask,ident]=mask_nubes(im,n_tile,output,varargin)
%Versión 1.1. Añade selector de outputs, todas las máscaras de satélite o
...
%si hemos pedido histogramas o imágenes, los condicionales las devuelven
if varargin(1)==1
...
% filtrado de mediana para eliminar píxeles solitarios
mask_S1=medfilt2(mask_S1,[5 5]); mask_S2=medfilt2(mask_S2,[5 5]);
mask_S4=medfilt2(mask_S4,[5 5]); mask_S3=medfilt2(mask_S3,[5 5]);

% si se han pedido histogramas o imagenes, el condicional las devuelve
if varargin(1)==1
    figure
...
%preparamos el output con todas las máscaras
...
%Más abajo codigo muerto que no dió resultados satisfactorios
